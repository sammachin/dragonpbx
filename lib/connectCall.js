    ...
    async getDest() {
        ...
        switch (this.params.type) {
            ...
            case 'trunk':
                ...
                let tdest = `${this.params.address}@${this.trunk.outbound.host}`
                if ('username' in this.trunk.outbound){
                    this.auth = {
                        username: this.trunk.outbound.username,
                        password: this.trunk.outbound.password
                    }
                }
                return  tdest;
        }
