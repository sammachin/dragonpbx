...
class connection extends Emitter {
    ...
    async action() {
        ...
        // Publish the client extensions this call is ringing toward so a
        // pickup verb in another session can find and steal it. Only for a
        // fresh (non-reconnect) connect while the A-leg is in early media.
        if (!isReconnect) {
